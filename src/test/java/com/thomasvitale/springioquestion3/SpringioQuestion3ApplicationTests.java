...
import com.thomasvitale.springioquestion3.model.Answers;
import com.thomasvitale.springioquestion3.model.GameScore;
...
@SpringBootTest(classes = SpringioQuestion3Application.class, webEnvironment = WebEnvironment.RANDOM_PORT)
@TestPropertySource(properties = "game.eventing.enabled=true")
@Testcontainers
public class SpringioQuestion3ApplicationTests {
    ...
    void whenAnswersSubmittedThenGameScoreReturned() throws InterruptedException {
        var answers = new Answers("jon-snow", UUID.randomUUID().toString(), false, false, true, false, 13);
        ...
        webTestClient
                ...
                .expectBody(GameScore.class).value(gameScore -> {
                    ...
                    assertThat(gameScore.level()).isEqualTo("springio-question-3");
